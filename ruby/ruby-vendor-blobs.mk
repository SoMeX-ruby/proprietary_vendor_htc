...
PRODUCT_COPY_FILES += \
  ...
  vendor/htc/ruby/proprietary/etc/firmware/firmware.bin:system/etc/wifi/firmware.bin \
  vendor/htc/ruby/proprietary/etc/firmware/firmware_ap.bin:system/etc/wifi/firmware_ap.bin \
  ...
  vendor/htc/ruby/proprietary/etc/firmware/a225p5_pm4.fw:system/etc/firmware/a225p5_pm4.fw \
  vendor/htc/ruby/proprietary/etc/firmware/a225_pfp.fw:system/etc/firmware/a225_pfp.fw \
  vendor/htc/ruby/proprietary/etc/firmware/a225_pm4.fw:system/etc/firmware/a225_pm4.fw \
  vendor/htc/ruby/proprietary/etc/firmware/a300_pfp.fw:system/etc/firmware/a300_pfp.fw \
  vendor/htc/ruby/proprietary/etc/firmware/a300_pm4.fw:system/etc/firmware/a300_pm4.fw \
  ...
  vendor/htc/ruby/proprietary/etc/firmware/yamato_pfp.fw:system/etc/firmware/yamato_pfp.fw \
  vendor/htc/ruby/proprietary/etc/firmware/yamato_pm4.fw:system/etc/firmware/yamato_pm4.fw 
